...
export default function CaptainConfirmRidePopup({ setConfirmRidePopup, setRidePopupPanel }) {
    return (
        <div>
            ...
            <div className="flex flex-col justify-between items-center gap-2 h-[70vh]">
                ...
                <button className="w-full mt-5 mt- bg-green-600 text-white font-semibold px-2 py-3 rounded-lg text-lg">Confirm</button>
