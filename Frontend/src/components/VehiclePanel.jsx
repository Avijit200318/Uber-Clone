...
export default function VehiclePanel({setVehiclePanel, setConfirmRidePanel}) {
    return (
        <div>
            ...
            <div onClick={()=> setConfirmRidePanel(true)} className="flex w-full p-3 items-center justify-between border-2 active:border-black rounded-md mb-2">
